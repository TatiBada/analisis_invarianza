...
folder_path = os.path.join(main_directory, 'transfer_learning')
print(folder_path)
#%%
...
df_complete = df_complete[['epoch', 'time', 'loss', 'acc', 'top5',
       ...
       'Training']]
#%%
df_complete.to_csv('complete_history_transfer_learning.csv',index=False)
...
main_directory = '/home/tbadaracco/models/efficientnet_b0/transfer_learning'
        ...
        with torch.no_grad():
            ...
            for i, transformacion in enumerate(transformaciones):
                ...
                try:
                    ...
                    df_progress1 = None
                if df_progress1 is not None and not df_progress1.empty:
